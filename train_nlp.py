...
import argparse
# python TrainNLP.py -inter_propor 0.1 -save_path int0.1 -archi mini
# python TrainNLP.py -inter_propor 0.3 -save_path int0.3 -archi mini
# python TrainNLP.py -inter_propor 0.5 -save_path int0.5 -archi mini
# python TrainNLP.py -inter_propor 0.7 -save_path int0.7 -archi mini
# python TrainNLP.py -inter_propor 0.9 -save_path int0.9 -archi mini
