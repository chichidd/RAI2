...
if __name__ == '__main__':
    ...
    parser.add_argument('-subset', type=int, default=1, help='subset index, 1 or 2, 1 denotes the victim part and 2 denotes the adversary or surrogate part')
    parser.add_argument('-inter_propor', type=float, default=0.5, help="intersection proportion between two subsets")
