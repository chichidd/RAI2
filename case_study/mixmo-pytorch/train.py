...
# python train.py -g 0 --config_path resnet182-2_cutmixmo-p5.yaml --dataplace dataplace --inter_propor 1.0 --saveplace int_1.0 --copy_id 2
...
def parse_args():
    ...
    parser.add_argument("--inter_propor", "-ip", type=float, default=None, help="intersection proportion", required=True)
    ...
    parser.add_argument("--copy_id", default=0, type=int, help="copy_id")
    ...
    args.saveplace = args.saveplace + f"_{args.copy_id}"
    args.seed = args.seed + args.copy_id
    if not os.path.exists(args.saveplace):
        os.makedirs(args.saveplace)
...
def transform_args(args):
    ...
    config_args['inter_propor'] = args.inter_propor
